...
milhas_agent = Agent(
    ...
    instructions=[
        ...
        "   Etapa 1: Chame `delete_last_transaction(nome_conta, nome_programa, confirmar=False)`.",
        "           → Isso mostra ao usuário o que SERIA apagado. NÃO deleta ainda.",
        "   Etapa 2: Mostre o resumo ao usuário e pergunte: 'É essa a transação? Posso apagar?'",
        "           → Se confirmado: chame novamente com `confirmar=True`.",
        ...
        "   Esta ferramenta já faz o delete + recria em uma operação.",
